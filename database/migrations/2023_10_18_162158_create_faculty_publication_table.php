...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('faculty_publication', function (Blueprint $table) {
            $table->increments('id');
            $table->string('publicationType',100)->nullable()->default(NULL);
            $table->string('origin',100)->nullable()->default(NULL);
            $table->string('publicationTitle',1000)->nullable()->default(NULL);
            $table->string('publicationStatus',50)->nullable()->default(NULL);
    ...
    {
        Schema::dropIfExists('faculty_publication');
    }
};
