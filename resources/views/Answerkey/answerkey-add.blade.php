                                ...
                                <div class="card table-card"> 
                                    ...
                                    <div class="card-body p-0"> 
                                        ...
                                        <div class="input-form" style="padding: 30px"> 
                                            ...
                                            <form action="{{url('/answerkey/store')}}" method="POST" enctype="multipart/form-data"> 
                                                    ...
                                                    <div class="col-md-8"> 
                                                        ...
                                                        <div class="form-row"> 
                                                            ...
                                                            <div class="form-group col-md-12"> 
                                                                ...
                                                                <input type="text" class="form-control"name="answerBody" id="answerBody" placeholder="answerBody" > 
                                                        ...
                                                        <div class="form-row"> 
                                                            ...
                                                            <div class="form-group col-md-12"> 
                                                                ...
                                                                <input type="text" class="form-control"name="answerType" id="answerType" placeholder="answerType" > 
